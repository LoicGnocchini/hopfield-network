...
img1 = Image.open("docs/images/dither_it_projet3075_louna.jpg").convert("L")   # niveaux de gris
img2 = Image.open("docs/images/dither_it_projet3075_xav_2.jpg").convert("L")   # niveaux de gris
img3 = Image.open("docs/images/dither_it_projet3075_xav_gros.jpg").convert("L")   # niveaux de gris
